...
public class ClientData
{
    ...
    public string[] Building01Desc = new string[7]{"Locked\nDo Upgrade it.", "Basic Research available", " Intermediate Research available", "Advanced Research available", "Advanced Research available", "Advanced Research available", "Advanced Research available" };
    public string[] Building02Desc = new string[7]{"Locked\nDo Upgrade it.", "BuldingDesc[1]\ndfd", "BuldingDesc[2]", "BuldingDesc[3]", "BuldingDesc[4]", "BuldingDesc[5]", "BuldingDesc[6]" };
